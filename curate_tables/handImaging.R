############################################
#' Script to curate Hand Imaging data from 
...
SCRIPT_PATH <- "curate_tables/handImaging.R"
...
HAND_IMAGING_TBL <- 'syn20547735'
OUTPUT_TBL_NAME <- 'HandImaging-Curated'
FILE_HANDLE_COLS <-  c("leftHand.png", "leftHand.jpg",
                       "rightHand.png", "rightHand.jpg",
                       "summaryImage.jpg")
...
main <- function(){
    ...
    create_table <- c(HAND_IMAGING_TBL) %>%
        ...
        regenerate_table(tbl_name = OUTPUT_TBL_NAME,
                         ...
                         file_handle_cols = FILE_HANDLE_COLS,
                         new_cols = NEW_COLS,
                         src_tbl_id = c(HAND_IMAGING_TBL),
                         used = c(HAND_IMAGING_TBL),
                         executed = GIT_URL,
                         name = "curate hand imaging")
}
