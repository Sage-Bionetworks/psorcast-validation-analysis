############################################
#' Script to curate psoriasis area photo from 
...
PSORIASIS_PHOTO_TBL <- 'syn21119212'
OUTPUT_TBL_NAME <- 'PsoriasisAreaPhoto-Curated'
FILE_HANDLE_COLS <-  c("psoriasisAreaPhoto.png",
...
main <- function(){
    ...
    create_table <- c(PSORIASIS_PHOTO_TBL) %>%
        ...
        regenerate_table(tbl_name = OUTPUT_TBL_NAME,
                         ...
                         file_handle_cols = FILE_HANDLE_COLS,
                         new_cols = NEW_COLS,
                         src_tbl_id = c(PSORIASIS_PHOTO_TBL),
                         used = c(PSORIASIS_PHOTO_TBL),
                         executed = GIT_URL,
                         name = "curate area photo")
}
